...
class UserProfile(models.Model):
    ...
    profile_image = models.ImageField(
        null=True, blank=True, upload_to='profile_images/', default="Images/user-default.png")
...
class Recipe(models.Model):
    ...
    featured_image = models.ImageField(upload_to='recipes_images/', null = True, blank = True, default="Images/default.jpg")
